...
func (n *NoOpMetrics) RecordCacheHit(ctx context.Context, dataProvider, streamID string) {}

func (n *NoOpMetrics) RecordCacheMiss(ctx context.Context, dataProvider, streamID string) {}

func (n *NoOpMetrics) RecordCacheDataServed(ctx context.Context, dataProvider, streamID string, rowCount int) {}

func (n *NoOpMetrics) RecordCacheDataAge(ctx context.Context, dataProvider, streamID string, ageSeconds float64) {}
